...
/*   Updated: 2020/08/27 02:49:54 by fde-capu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	scn_make_square(t_scn *sc, char **c)
{
	...
	square = square_init(ft_atov(c[1]), ft_atov(c[2]), ft_atod(c[3]), ft_atorgb(c[4]));
	...
	tri[1] = triangle_init(vector_copy(p[2]), p[3], vector_copy(p[0]), square->rgb);
